$(document).ready(function() {
    ...
    var scatterClasses = [
        'scatter1', 'scatter2', 'scatter3', 'scatter4', 'scatter5', 'scatter6', 'scatter7', 'scatter8', 'scatter9', 'scatter10'
    ];
    ...
    function runScatter(petalObject) {
        ...
        var randomClass = scatterClasses[Math.floor(Math.random() * scatterClasses.length)];
